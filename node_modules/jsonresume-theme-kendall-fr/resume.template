    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-7">
          ...
          <!-- ABOUT ME -->
          <div class="box">
            <h2><i class="fa fa-user ico"></i> A propos</h2>
            <p>{{{basics.summary}}}</p>
          </div>
          {{/basics.summary}}
          {{#workBool}}
          <!-- WORK EXPERIENCE -->
          <div class="box">
            <h2><i class= "fa fa-suitcase ico"></i> Experience professionnelle</h2>
            {{#work}}
                ...
                <div class="row">
                  <div class="job-details col-xs-11">
                    ...
                    <div class="description">
                      {{{summary}}}
                      {{#boolHighlights}}
                      <div class="highlights">Notes</div>
                      <ul class="list-group">
                        {{#highlights}}
          ...
          <!-- VOLUNTEER -->
          <div class="box">
            <h2><i class= "fa fa-group ico"></i> Volontariat</h2>
            {{#volunteer}}
              <div class="job clearfix">
                <div class="row">
                  <div class="details">
        ...
        <div class="col-xs-12 col-sm-5">
          ...
          <!-- SKILLS -->
          <div class="box">
            <h2><i class="fa fa-tasks ico"></i> Competences</h2>
            {{#skills}}
          ...
          <!-- LANGUAGES -->
          <div class="box">
            <h2><i class="fa fa-language ico"></i> Langages</h2>
            <ul class="list-group">
              {{#languages}}
          ...
          <!-- HOBBIES -->
          <div class="box">
            <h2><i class="fa fa-heart ico"></i> Interets</h2>
            {{#interests}}
